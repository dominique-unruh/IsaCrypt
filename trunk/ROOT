session "IsaCrypt" = "IsaCrypt-Prereqs" +
  ...
  theories (*ISACRYPT_THYS*) Distr ElGamal Extended_Sorry Hoare_Tactics Hoare_Typed Hoare_Untyped Lang_Typed Lang_Untyped Modules Procedures Procs_Typed RHL_Typed RHL_Untyped TermX_Antiquot Tools TypedLambda Universe
  document_files (in ".")
    "root.tex"
