...
session "IsaCrypt-Nodocs" = "IsaCrypt-Prereqs" +
  ...
  theories [document = false]
  theories (*ISACRYPT_THYS*) Distr ElGamal Extended_Sorry Hoare_Tactics Hoare_Typed Hoare_Untyped Lang_Simplifier Lang_Typed Lang_Untyped Procedures Procs_Typed RHL_Typed RHL_Untyped Scratch2 Scratch3 Tactic_Inline TermX_Antiquot Tools TypedLambda Universe
  document_files (in ".")
    "root.tex"
